...
# -*- coding: utf-8 -*-
#
# mijnahlib documentation build configuration file, created by
...
sphinx.apidoc.main(argv=['_','-f', '-o', os.path.join(project_root, 'docs'),
                   os.path.join(project_root, '''mijnahlib''')])
...
version = mijnahlib.__version__
# The full version, including alpha/beta/rc tags.
release = mijnahlib.__version__
...
htmlhelp_basename = '''mijnahlibdoc'''
